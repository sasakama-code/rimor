...
import { Issue, Severity, IssueType, AnnotationOptions, DataFlow } from '../../src/reporting/types';
...
describe('AnnotationGenerator', () => {
  ...
  describe('generateAnnotation', () => {
    ...
    it('should include references in block format', () => {
      const issueWithRefs: Issue = {
        ...baseIssue,
        references: ['https://owasp.org/sql-injection', 'CWE-89'],
      };
  ...
  describe('generateLanguageSpecificAnnotation', () => {
    ...
    it('should generate Python-style inline annotation', () => {
      const annotation = generator.generateLanguageSpecificAnnotation(issue, 'script.py');
    ...
    it('should generate Python-style block annotation', () => {
      ...
      const annotation = generator.generateLanguageSpecificAnnotation(issue, 'script.py', options);
    ...
    it('should generate HTML-style annotation', () => {
      const annotation = generator.generateLanguageSpecificAnnotation(issue, 'index.html');
