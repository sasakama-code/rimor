...
describe('Taint Annotations', () => {
  describe('@Tainted decorator', () => {
    ...
    it('should mark method as tainted', () => {
      ...
      const metadata = TaintAnnotationReader.getTaintMetadata(TestClass.prototype, 'fetchUserData');
  ...
  describe('@SuppressTaintWarning decorator', () => {
    ...
    it('should suppress warnings on properties', () => {
      ...
      const metadata = TaintAnnotationReader.getSuppressMetadata(TestClass.prototype, 'legacyData');
  ...
  describe('Integration scenarios', () => {
    ...
    it('should maintain metadata timestamps', () => {
      ...
      const metadata = TaintAnnotationReader.getTaintMetadata(TimestampTest.prototype, 'data');
