...
describe('CLI', () => {
  ...
  beforeEach(() => {
    ...
    (AnalyzeCommandV8 as jest.MockedClass<typeof AnalyzeCommandV8>).mockImplementation(
      () => mockAnalyzeCommand
    );
  });
  ...
  describe('domain-analyze command', () => {
    ...
    beforeEach(() => {
      ...
      (DomainAnalyzeCommand as jest.MockedClass<typeof DomainAnalyzeCommand>).mockImplementation(
        () => mockDomainAnalyzeCommand
      );
    });
    ...
    it('should execute domain-analyze command with default options', async () => {
      ...
      expect(mockDomainAnalyzeCommand.execute).toHaveBeenCalledWith(
